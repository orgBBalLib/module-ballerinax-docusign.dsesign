...
public isolated client class Client {
    ...
    # Returns the result of updating or transferring templates within the account.
    #
    # + accountId - The external account number (int) or account ID GUID
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    ...
    # Returns the results of updating auto-match settings for templates in the specified account.
    #
    # + accountId - The external account number (int) or account ID GUID
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
