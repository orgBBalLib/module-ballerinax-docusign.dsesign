...
public isolated client class Client {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Successful response 
    resource isolated function get v2\.1/accounts/[string accountId]/envelopes/[string envelopeId]/audit_events(map<string|string[]> headers = {}, *AuditEventsGetAuditEventsQueries queries) returns http:Response|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/accounts/[string accountId]/envelopes/[string envelopeId]/recipients/[string recipientId]/identity_proof_token(map<string|string[]> headers = {}, *RecipientsPostRecipientProofFileResourceTokenQueries queries) returns http:Response|error {
    ...
    # Returns the result of creating envelope shares with the specified users or groups.
    #
    # + accountId - The external account number (int) or account ID GUID
    # + envelopeId - The envelope's GUID. 
    # Example: `93be49ab-xxxx-xxxx-xxxx-f752070d71ec`
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/accounts/[string accountId]/envelopes/[string envelopeId]/shares(EnvelopesSharesRequest payload, map<string|string[]> headers = {}) returns http:Response|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/accounts/[string accountId]/envelopes/[string envelopeId]/views/correct(EnvelopeViewRequest payload, map<string|string[]> headers = {}) returns http:Response|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/accounts/[string accountId]/envelopes/[string envelopeId]/views/edit(EnvelopeViewRequest payload, map<string|string[]> headers = {}) returns http:Response|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/accounts/[string accountId]/envelopes/[string envelopeId]/views/sender(EnvelopeViewRequest payload, map<string|string[]> headers = {}) returns http:Response|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function put v2\.1/accounts/[string accountId]/settings/notification_defaults(NotificationDefaults payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/settings/notification_defaults`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function put v2\.1/accounts/[string accountId]/settings/password_rules(AccountPasswordRules payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/settings/password_rules`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + return - Successful response 
    resource isolated function put v2\.1/accounts/[string accountId]/signing_groups/[string signingGroupId]/users(SigningGroupUsers payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/signing_groups/${getEncodedUri(signingGroupId)}/users`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + payload - A complex type that contains information about users in the signing group 
    # + return - Successful response 
    resource isolated function delete v2\.1/accounts/[string accountId]/signing_groups/[string signingGroupId]/users(SigningGroupUsers payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/signing_groups/${getEncodedUri(signingGroupId)}/users`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # Returns the result of updating or importing templates for the specified account.
    #
    # + accountId - The external account number (int) or account ID GUID
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function put v2\.1/accounts/[string accountId]/templates(TemplateAutoMatchList payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/templates`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function put v2\.1/accounts/[string accountId]/templates/[string templateId]/custom_fields(TemplateCustomFields payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/templates/${getEncodedUri(templateId)}/custom_fields`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/accounts/[string accountId]/templates/[string templateId]/custom_fields(TemplateCustomFields payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/templates/${getEncodedUri(templateId)}/custom_fields`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function delete v2\.1/accounts/[string accountId]/templates/[string templateId]/custom_fields(TemplateCustomFields payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/templates/${getEncodedUri(templateId)}/custom_fields`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + queries - Queries to be sent with the request 
    # + return - Successful response 
    resource isolated function put v2\.1/accounts/[string accountId]/templates/[string templateId]/recipients(TemplateRecipients payload, map<string|string[]> headers = {}, *RecipientsPutTemplateRecipientsQueries queries) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/templates/${getEncodedUri(templateId)}/recipients`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # + queries - Queries to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/accounts/[string accountId]/templates/[string templateId]/recipients(TemplateRecipients payload, map<string|string[]> headers = {}, *RecipientsPostTemplateRecipientsQueries queries) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/templates/${getEncodedUri(templateId)}/recipients`;
        resourcePath = resourcePath + check getPathForQueryParam(queries);
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function delete v2\.1/accounts/[string accountId]/templates/[string templateId]/recipients(TemplateRecipients payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/templates/${getEncodedUri(templateId)}/recipients`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function delete v2\.1/accounts/[string accountId]/templates/[string templateId]/recipients/[string recipientId](TemplateRecipients payload, map<string|string[]> headers = {}) returns http:Response|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/accounts/[string accountId]/templates/[string templateId]/views/edit(TemplateViewRequest payload, map<string|string[]> headers = {}) returns http:Response|error {
    ...
    # Returns the results of the auto-match operation for the specified templates in the account.
    #
    # + accountId - The external account number (int) or account ID GUID
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function put v2\.1/accounts/[string accountId]/templates/auto_match(TemplateAutoMatchList payload, map<string|string[]> headers = {}) returns http:Response|error {
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/accounts/[string accountId]/users/[string userId]/cloud_storage(CloudStorageProviders payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/users/${getEncodedUri(userId)}/cloud_storage`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function delete v2\.1/accounts/[string accountId]/users/[string userId]/cloud_storage(CloudStorageProviders payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/accounts/${getEncodedUri(accountId)}/users/${getEncodedUri(userId)}/cloud_storage`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function put v2\.1/current_user/notary(Notary payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/current_user/notary`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/current_user/notary(Notary payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/current_user/notary`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function post v2\.1/current_user/notary/jurisdictions(NotaryJurisdiction payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/current_user/notary/jurisdictions`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
    ...
    # + headers - Headers to be sent with the request 
    # + return - Successful response 
    resource isolated function put v2\.1/current_user/notary/jurisdictions/[string jurisdictionId](NotaryJurisdiction payload, map<string|string[]> headers = {}) returns http:Response|error {
        string resourcePath = string `/v2.1/current_user/notary/jurisdictions/${getEncodedUri(jurisdictionId)}`;
        http:Request request = new;
        json jsonBody = jsondata:toJson(payload);
        request.setPayload(jsonBody, "application/json");
